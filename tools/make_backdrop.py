...
# 0.42 でもまだ暗いという報告を受け、0.60 まで上げた。
# 併せて膜を 0.10〜0.38 まで薄くし、代わりに **文字が乗るパネルだけ**
# 0.78 へ濃くしてある。絵は余白で見せ、文字はパネルで読ませる。
# このとき余白の明るさは 0.76（当初の 0.025 の30倍）、
# 本文 7.9:1 / 補助 5.5:1 で基準（4.5:1）に余裕がある。
TARGET_TOP = 0.60
