...
RPG.data.quests = {
   ...
   *   素直な4人     6〜 9R（中央 6）
   *
   * 12ラウンドで切ると、単騎は落ち、3人は通る。
   * **縛りが2種類になったが、1種類では成立しないと分かった上での2つ目。**
   */
  q_three_at_the_verge: {
    name: '三で足りる',
    desc: '臨界の際を3人以下・12ラウンド以内で抜ける。相手は数で来るので、1枠減るのは重い。'
      + 'それでも誰を連れるかで所要は倍変わる。オートのままでよい。'
      + 'ひとりで粘って削り切る手は、時間が足りない。',
    fieldId: 'fl_verge', waves: 5, bossFinale: true,
    // オート禁止を書かない＝オートで挑める。
    // maxRounds は単騎の消耗戦を弾くため（上の実測）。
    rules: { maxParty: 3, maxRounds: 12 },
    unlock: { level: 200 },
    reward: {
      gold: 60000,
