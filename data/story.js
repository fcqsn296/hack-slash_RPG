    ...
    chapters: [
      {
        ...
        scenes: [
          ...
          },
          {
            ...
            lines: [
              { who: null, text: '長老は{主人公}の腕を一度だけ見て、すぐに目を逸らした。' },
          ...
          },
          {
            ...
            lines: [
              ...
              { who: null, text: '{主人公}が手を触れると、腕の下で銀が音もなく流れ、継ぎ目に沿って光が走った。' },
        ...
        scenes: [
          ...
          },
          {
            ...
            lines: [
              ...
              { who: null, text: '{主人公}が触れた覚えのない操作面に、腕の銀が流れ込んでいく。' },
        ...
        scenes: [
          ...
          },
          {
            ...
            lines: [
              ...
              { who: null, text: '{主人公}が近づくと、瞼が上がった。埃も落ちなかった。' },
          ...
          },
          {
            ...
            lines: [
              ...
              { who: 'ch_rizel', text: '……集落。あそこ、まだ人がいる。' },
              { who: 'ch_astra', text: '見込みのある個体は、収容の対象です。' },
              { who: 'ch_rizel', text: '見込みって、なによ。誰が決めるの。' },
              { who: 'ch_astra', text: '機構が。……当時の基準で。' },
      ...
      },
      {
        id: 'ch4',
        name: '第四章　間に合わなかったもの',
        lead: '塞がれていた板が応える。順路の下で、旧文明が何を選んだのかを知る。',
        scenes: [
          {
            id: 'ch4_open',
            when: null,
            lines: [
              { who: null, text: '板の前に立つ。三度目だった。' },
              { who: 'ch_astra', text: '——応答が変わっています。' },
              { who: 'ch_hero', text: '何が。' },
              { who: 'ch_astra', text: '前回、この板は継承者を照合できませんでした。いまは照合できます。' },
              { who: 'ch_rizel', text: '何が変わったの。こっちは何もしてないけど。' },
              { who: 'ch_astra', text: 'わたしを受領されました。零式の受領記録が、継承者の証明になります。' },
              { who: 'ch_shiki', text: '……鍵が、あんた自身だったってこと。' },
              { who: null, text: '{主人公}が手を触れると、板は音も立てずに滑った。' },
              { who: null, text: '下りの階段。空気が乾いていて、灰の匂いがまったくしない。' },
            ],
            // ch4_opened は mp_deep の降り口を開ける印。導入で直接連れて行くが、
            // 一度戻ってから降り直せるように、旗も同時に立てておく。
            then: { enterMap: 'mp_sealed', flag: 'ch4_opened' },
          },
          {
            id: 'ch4_arrive',
            when: { flag: 'saw_mp_sealed' },
            lines: [
              { who: null, text: '降りた先は、円い回廊だった。壁沿いにぐるりと道が続いている。' },
              { who: 'ch_rizel', text: '……道が、輪になってる。これ、どこにも行かないじゃない。' },
              { who: 'ch_astra', text: '順路です。巡回のために引かれています。' },
              { who: 'ch_shiki', text: '巡回。ずっと歩いてるってこと。誰が。' },
              { who: null, text: '答えの代わりに、遠くで足音がした。同じ間隔で、同じ重さで。' },
              { who: 'ch_hero', text: '……止まっていないな。' },
              { who: 'ch_astra', text: 'はい。命令が続いていますので。' },
            ],
          },
          {
            id: 'ch4_record',
            ...
            lines: [
              { who: null, text: '回廊の中心に、扉の無い部屋があった。壁一面が棚で、その棚が全部空だった。' },
              { who: 'ch_rizel', text: '……空っぽ。持ち出されたの？' },
              { who: 'ch_astra', text: 'いいえ。ここは索引です。中身は各地の保管庫にあります。' },
              { who: null, text: '床の中央に、板が一枚だけ残っていた。触れると、掠れた文字が浮かぶ。' },
              { who: null, text: '『流入、停止の見込みなし。』' },
              { who: null, text: '『現行世代の適応、不可と判断。』' },
              { who: 'ch_shiki', text: '……不可。自分たちのことを、そう書いたの。' },
              { who: 'ch_astra', text: 'はい。当時の観測に基づく判断です。' },
              { who: 'ch_rizel', text: '待って。じゃあ、この人たちは。' },
              { who: null, text: '『以後、資源は次代の保存に充てる。』' },
              { who: null, text: '『各地に保管庫を設け、見込みのある個体を意識ごと記録する。』' },
              { who: null, text: '『——救援計画は、これをもって終了とする。』' },
              { who: null, text: '誰も、しばらく何も言わなかった。' },
              { who: 'ch_rizel', text: '……自分を助けるのを、やめたってこと。' },
              { who: 'ch_astra', text: 'はい。' },
              { who: 'ch_hero', text: '襲われたわけではないのか。誰かに滅ぼされたわけでは。' },
              { who: 'ch_astra', text: '記録にありません。エーテルは濃くなり続けただけです。' },
              { who: 'ch_astra', text: '意志も、要求も、記録されていません。' },
              { who: 'ch_shiki', text: '……恨む相手すら、いないんだ。' },
              { who: 'ch_rizel', text: 'それって、どっちが。' },
              { who: 'ch_rizel', text: '……ううん。やめとく。' },
              { who: null, text: '棚が空なのは、持ち出されたからではなかった。' },
              { who: null, text: 'ここへ納めるはずだったものが、間に合わなかったのだ。' },
            ],
          },
          {
            id: 'ch4_unus',
            when: { flag: 'met_unus' },
            lines: [
              { who: null, text: '順路の先に、それは立っていた。歩くのをやめて、こちらを見ている。' },
              { who: 'ch_astra', text: '一番機です。' },
              { who: null, text: '背は{主人公}より高い。装甲は磨かれていない。ただ、欠けてもいなかった。' },
              { who: null, text: '『——継承者。受領は完了したか。』' },
              { who: 'ch_hero', text: '……ああ。零式は受け取った。' },
              { who: null, text: '『では、次を渡す。収容者を増やす。順路を延長する。』' },
              { who: 'ch_rizel', text: '延長って、どこまで。' },
              { who: null, text: '『上へ。地表の集落まで。見込みのある個体は残っている。』' },
              { who: 'ch_shiki', text: '……あそこ、あたしたちの隣よ。' },
              { who: 'ch_hero', text: '待て。その命令は、もう果たされている。' },
              { who: null, text: '『渡す相手が現れた場合、待機は解除される。渡す対象は増やす。矛盾はない。』' },
              { who: 'ch_astra', text: '……解釈が、戻りません。長すぎたのです。' },
              { who: 'ch_hero', text: '——なら、こちらで止める。' },
            ],
          },
          {
            id: 'ch4_end',
            ...
            lines: [
              { who: null, text: '装甲が沈み、順路の中央で膝を折った。' },
              { who: null, text: '『……受領は。』' },
              { who: 'ch_astra', text: '完了しています。零式は継承者へ渡りました。' },
              { who: null, text: '『では、待機の理由は。』' },
              { who: 'ch_astra', text: 'ありません。' },
              { who: null, text: '長い間があった。機体は、それを何度も確かめているように見えた。' },
              { who: null, text: '『——了解。巡回を終了する。』' },
              { who: null, text: '足音が、止まった。' },
              { who: 'ch_rizel', text: '……終わったの？' },
              { who: 'ch_shiki', text: '終わらせたのよ。ずっと、誰かが来るのを待ってた。' },
              { who: 'ch_hero', text: '……間に合わなかったものの、続きだ。' },
              { who: null, text: '棚は空のままだった。だが、順路にはもう誰も歩いていない。' },
              { who: null, text: '——第四章 了' },
            ],
            then: { clear: true },
          },
