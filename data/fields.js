...
RPG.data.fields = {
  ...
  fl_origin: {
    ...
    // 1周の総収入が上でも時間あたりで負ける。→ 5,515 になり手前を 4.9% 上回る。
    gold_mult: 0.28, exp_mult: 0.42, box_mult: 1.32, postGacha: true,
    bg: ['#1b2338', '#07090f'],
  ...
  fl_endless: {
    ...
    // 4,375 → 6,474。「常に格上な代わりに実入りが濃い」という形にして辻褄を合わせる。
    gold_mult: 0.32, exp_mult: 0.52, box_mult: 1.49, postGacha: true,
    bg: ['#241a2e', '#0a0710'],
    /**
  ...
  fl_verge: {
    ...
    // box_mult 1.22: 回廊を厚くしたぶん、ここが追い越されないように上げる。
    // 5,739 → 6,931。
    gold_mult: 0.36, exp_mult: 0.56, box_mult: 1.22, postGacha: true,
    bg: ['#2b2536', '#0c0a12'],
