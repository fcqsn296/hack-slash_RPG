 ...
 */
/**
 * 鍛冶（強化・厳選・再抽選）が使えるようになる主人公のレベル (§7.6)。
 *
 * ── なぜ待たせるか ──
 * 序盤は数フィールドごとに装備を丸ごと乗り換える。そこで強化に払っても、
 * next の宝箱1つで捨てることになる。**投資が必ず無駄になる期間**がある。
 *
 * 推奨Lv50 の「忘却の遺構」から銀の宝箱が落ちなくなり、
 * 竜（レジェンド50%）と金だけになる。乗り換えが落ち着くのがここ。
 */
RPG.data.forgeUnlockLevel = 50;
